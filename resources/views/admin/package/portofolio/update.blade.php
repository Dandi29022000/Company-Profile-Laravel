        ...
        <div class="col-md-8">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary">Form Update Data Portofolio</h5>
                </div>
                ...
                <div class="card-body">
                    <form action="{{ route('portofolio.update', $portofolio->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" name="id" placeholder="Id" type="text" value="{{ $portofolio->id }}" readonly>
                        </div>
                        <br>
                            <div class="input-group">
                                <label for="judul" class="col-md-4 col-form-label text-md-end">{{ __('Judul') }}</label>
                                <input class="form-control" name="judul" placeholder="Judul" type="text" value="{{ $portofolio->judul }}">
                            </div>
                        <br>
                            <div class="input-group">
                                <label for="deskripsi" class="col-md-4 col-form-label text-md-end">{{ __('Deskripsi') }}</label>
                                <input class="form-control" name="deskripsi" placeholder="Deskripsi" type="text" value="{{ $portofolio->deskripsi }}">
                            </div>
                        <br>
                        <div class="input-group">
                            <label for="gambar" class="col-md-4 col-form-label text-md-end">{{ __('Masukkan Foto') }}</label>
                            <input class="form-control" name="gambar" type="file" value="{{ $portofolio->gambar }}">
                            <img width="150px" src="{{asset('storage/'.$portofolio->gambar)}}">
                        </div>
                        <br>
                            <div class="row">
                                <div class="col-md-6">
